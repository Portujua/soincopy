...
insert into Departamento(nombre) values ("Archivo");
...
insert into Permiso (nombre, descripcion, riesgo, categoria) values ("pedidos_ver_por_procesar", "Podrá consultar los pedidos pendientes por procesar o por entregar en el sistema", 10, 16);
...
insert into Producto (nombre, descripcion, departamento, fecha_creado, familia, exento_iva, estado, tokens) values 
	("Impresion de Guia", "", 1, now(), 2, 0, 1, "impresion guia hoja carta");
